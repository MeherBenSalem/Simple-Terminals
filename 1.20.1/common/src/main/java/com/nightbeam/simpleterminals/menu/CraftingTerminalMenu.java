...
public class CraftingTerminalMenu extends AbstractContainerMenu {
    ...
    public CraftingTerminalMenu(int containerId, Inventory playerInventory, FriendlyByteBuf buffer) {
    ...
    private void updateCraftingResult() {
        ...
        ItemStack result = player.level().getServer().getRecipeManager()
                ...
                .map(recipe -> {
                    ...
                    return recipe.assemble(craftingGrid, player.level().registryAccess());
                })
